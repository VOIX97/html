...
<div id="wrapper1">
	<div id="header-wrapper">
		<div id="header" class="container">
			<div id="logo"> <img src='1.png' width = '200' height = '124' >
				<h1><a href="Homepage.html"><span>S</span>bml<span>D</span>iffer</a></h1>
    ...
    if(is_uploaded_file($_FILES['myfile1']['tmp_name'])) {
        ...
        $move_to_file1="/var/www/html/metlab/".$_FILES['myfile1']['name'];
    ...
    if(is_uploaded_file($_FILES['myfile2']['tmp_name'])) {
        ...
        $move_to_file2="/var/www/html/metlab/".$_FILES['myfile2']['name'];
    ...
    exec($command1);
	exec($command2);
	echo '<img src='.$_FILES['myfile1']['name'].'.png>';
?>
		</div>
	</div>
